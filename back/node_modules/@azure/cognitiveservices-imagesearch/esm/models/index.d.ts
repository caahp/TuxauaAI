 ...
 */
export declare type ResponseUnion = Response | AnswerUnion | ThingUnion | ErrorResponse | RecognizedEntity | RecognizedEntityRegion | ImageInsights | TrendingImages;
/**
 ...
 */
export declare type ThingUnion = Thing | Organization | OfferUnion | CreativeWorkUnion | Person | IntangibleUnion;
/**
 * Defines a thing.
 */
 ...
 */
export declare type CreativeWorkUnion = CreativeWork | MediaObjectUnion | Recipe | WebPageUnion;
/**
 ...
 */
export declare type AnswerUnion = Answer | SearchResultsAnswerUnion;
/**
 * Defines an answer.
 */
 ...
 */
export declare type SearchResultsAnswerUnion = SearchResultsAnswer | Images;
/**
 ...
 */
export declare type WebPageUnion = WebPage | CollectionPageUnion;
/**
 ...
 */
export declare type CollectionPageUnion = CollectionPage | ImageGallery;
/**
 ...
 */
export declare type StructuredValueUnion = StructuredValue | NormalizedRectangle;
/**
 ...
 * @enum {string}
 */
export declare type ImageColor = 'ColorOnly' | 'Monochrome' | 'Black' | 'Blue' | 'Brown' | 'Gray' | 'Green' | 'Orange' | 'Pink' | 'Purple' | 'Red' | 'Teal' | 'White' | 'Yellow';
/**
 ...
 * @enum {string}
 */
export declare type Freshness = 'Day' | 'Week' | 'Month';
/**
 ...
 * @enum {string}
 */
export declare type ImageContent = 'Face' | 'Portrait';
/**
 ...
 * @enum {string}
 */
export declare type ImageType = 'AnimatedGif' | 'Clipart' | 'Line' | 'Photo' | 'Shopping' | 'Transparent';
/**
 ...
 * @enum {string}
 */
export declare type ImageLicense = 'All' | 'Any' | 'Public' | 'Share' | 'ShareCommercially' | 'Modify' | 'ModifyCommercially';
/**
 ...
 * @enum {string}
 */
export declare type ImageCropType = 'Rectangular';
/**
 ...
 * @enum {string}
 */
export declare type ImageInsightModule = 'All' | 'BRQ' | 'Caption' | 'Collections' | 'Recipes' | 'PagesIncluding' | 'RecognizedEntities' | 'RelatedSearches' | 'ShoppingSources' | 'SimilarImages' | 'SimilarProducts' | 'Tags';
/**
 * Contains response data for the search operation.
 */
export declare type ImagesSearchResponse = Images & {
    /**
 ...
 */
export declare type ImagesDetailsResponse = ImageInsights & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type ImagesTrendingResponse = TrendingImages & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
